...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const SourceIndicator = {
        VARIANTS: {
            gemini: { cls: 'source-badge--gemini', label: '🤖 Generated by Gemini AI' },
            cache:  { cls: 'source-badge--cache',  label: '⚡ Cached Response (Gemini)' },
            eci:    { cls: 'source-badge--eci',     label: '📜 Based on ECI Official Guidelines' },
        },
        ...
        set(source) {
            ...
            const variant = this.VARIANTS[source] || this.VARIANTS['eci'];
            badge.className = `source-badge ${variant.cls}`;
